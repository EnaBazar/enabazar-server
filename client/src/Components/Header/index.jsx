...
<div className="col1 w-full lg:w-[100%] overflow-hidden">
  <div className="marquee">
    <div className="marquee-track">
      <span>আমাদের যে কোন পন্য অর্ডার করতে কল বা WhatsUp করুন: 01674847446 -- 01677190919   
        সকল পন্যের উপর মোট ১৫০০ টাকার ক্রয় করলে সারা দেশে ডেরিভারি ফ্রী  !</span>
  ...
  <div className="col1 w-[60%] lg:w-[20%] flex items-center 
