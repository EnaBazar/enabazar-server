...
const Header =() => {
  ...
  <div className="marquee">
    <div className="marquee-track">
      <span>inabazarbd.com এ আপনাকে স্বাগতম| বাংলাদেশের বিশ্বস্ত অনলাইন শপ| সারা দেশর কেশ অন ডেলেভারি (৪৮ থেকে ৭২ ঘন্টার মধ্যে নিশ্চিত ডেরিভারি) সকাল ১০টা থেকে রাত ১০ টা পর্যন্ত | আমাদের যে কোন পন্য অর্ডার করতে কল বা WhatsUp করুন: 01674847446 </span>
