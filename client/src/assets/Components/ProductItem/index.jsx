...
const ProductItem =() =>{
    ...
    return(
     <div className='ProductItem shadow-md rounded-md overflow-hidden border-1 border-[rgba(0,0,0,0.2)] group '>
     ...
     <div className="info  p-3 py-0.5 bg-[#f1f1f1]">
     <h6 className="text-[12px] !font-[400]"><Link to="/" className="link transition-all">SleeperToyes</Link></h6>
     <h3 className='text-[13px] title mt-1 font-[500] mb-1 text-[#000]'><Link to="/" className='link transition-all'>Very Nice Frogy Slepper for babys..</Link></h3>
