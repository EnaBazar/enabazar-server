...
const handleCloseQty = (value) => {
  ...
  return (
    ...
    <span className='flex items-center justify-center bg-[#f1f1f1 text-[11px] font-[600]
    p-1 rounded-md py-1 px-2 cursor-pointer '   onClick={handleClickSize}>Size: {selectedSize} <GoTriangleDown/>
    </span>
    <Menu
         id="Size-menu"
    ...
    <div className='relative'>
    <span className='flex items-center justify-center bg-[#f1f1f1 text-[11px] font-[600]
    p-1 rounded-md py-1 px-2 cursor-pointer'onClick={handleClickQty}>Qty:{selectedQty} <GoTriangleDown/>
    </span>
