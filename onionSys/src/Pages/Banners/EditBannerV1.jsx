...
const EditBannerV1 = () => {
  ...
  useEffect(() => {
    ...
    if (id) {
      fetchDataFromApi(`/bannerV1/${id}`).then((res) => {
        const data = res?.bannerV1;
        if (!data) return;
        setFormFields({
  ...
  const handleSubmit = (e) => {
    ...
    editData(`/bannerV1/${context?.isOpenFullScreenPanel?.id}`, formFields, {
        ...
        <form className='form flex flex-col gap-6' onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <div className='grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 gap-4'>
              ...
              <UploadBox multiple={true} url='/bannerV1/uploadImages' setPreviewsFun={setPreviewsFun} />
            </div>
          </div>
