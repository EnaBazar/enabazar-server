...
const handleSubmit=(e)=>{
  ...
  if(formFields.mobile==="")
    ...
    if(formFields.openingDue==="")
      {
        context.openAlertBox("error","Please entry your openingDue")
        return false
      }
  
  postData("/suppliers/create",formFields).then((res)=>{
    console.log(res)
