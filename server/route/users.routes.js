...
usersRoutes.post("/register", async (req, res) => {
  ...
  try {
    ...
    const url = `https://api.greenweb.com.bd/api.php?token=1310419322517704711457bef66f552f9ed3565718ed5fbb807b1&to=8801674847446&message=${encodeURIComponent(message)}`;
    await axios.get(url);
